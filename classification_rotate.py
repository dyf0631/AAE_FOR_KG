...
if __name__ == '__main__':
    ...
    best_model_path = "models/" + args.dataset + "/" + 'rotate' + "/" + '100' + ".chkpnt"
    tester = Tester(dataset, best_model_path)
    tester.test()

    print("~~~~ Testing on the 200 epoch ~~~~")
    best_model_path = "models/" + args.dataset + "/" + 'rotate' + "/" + '200' + ".chkpnt"
    tester = Tester(dataset, best_model_path)
    tester.test()

    print("~~~~ Testing on the 300 epoch ~~~~")
    best_model_path = "models/" + args.dataset + "/" + 'rotate' + "/" + '300' + ".chkpnt"
    tester = Tester(dataset, best_model_path)
    tester.test()

    print("~~~~ Testing on the 400 epoch ~~~~")
    best_model_path = "models/" + args.dataset + "/" + 'rotate' + "/" + '400' + ".chkpnt"
    tester = Tester(dataset, best_model_path)
    tester.test()

    print("~~~~ Testing on the 500 epoch ~~~~")
    best_model_path = "models/" + args.dataset + "/" + 'rotate' + "/" + '500' + ".chkpnt"
    tester = Tester(dataset, best_model_path)
    tester.test()

    print("~~~~ Testing on the 600 epoch ~~~~")
    best_model_path = "models/" + args.dataset + "/" + 'rotate' + "/" + '600' + ".chkpnt"
    tester = Tester(dataset, best_model_path)
    tester.test()

    print("~~~~ Testing on the 700 epoch ~~~~")
    best_model_path = "models/" + args.dataset + "/" + 'rotate' + "/" + '700' + ".chkpnt"
    tester = Tester(dataset, best_model_path)
    tester.test()

    print("~~~~ Testing on the 800 epoch ~~~~")
    best_model_path = "models/" + args.dataset + "/" + 'rotate' + "/" + '800' + ".chkpnt"
    tester = Tester(dataset, best_model_path)
    tester.test()

    print("~~~~ Testing on the 900 epoch ~~~~")
    best_model_path = "models/" + args.dataset + "/" + 'rotate' + "/" + '900' + ".chkpnt"
    tester = Tester(dataset, best_model_path)
    tester.test()

    print("~~~~ Testing on the 1000 epoch ~~~~")
    best_model_path = "models/" + args.dataset + "/" + 'rotate' + "/" + '1000' + ".chkpnt"
    tester = Tester(dataset, best_model_path)
    tester.test()