...
if __name__ == '__main__':
    ...
    best_model_path = "models/" + args.dataset + "/" + 'complex' + "/" + '100' + ".chkpnt"
    tester = Tester(dataset, best_model_path)
    tester.test()

    print("~~~~ Testing on the 200 epoch ~~~~")
    best_model_path = "models/" + args.dataset + "/" + 'complex' + "/" + '200' + ".chkpnt"
    tester = Tester(dataset, best_model_path)
    tester.test()

    print("~~~~ Testing on the 300 epoch ~~~~")
    best_model_path = "models/" + args.dataset + "/" + 'complex' + "/" + '300' + ".chkpnt"
    tester = Tester(dataset, best_model_path)
    tester.test()

    print("~~~~ Testing on the 400 epoch ~~~~")
    best_model_path = "models/" + args.dataset + "/" + 'complex' + "/" + '400' + ".chkpnt"
    tester = Tester(dataset, best_model_path)
    tester.test()

    print("~~~~ Testing on the 500 epoch ~~~~")
    best_model_path = "models/" + args.dataset + "/" + 'complex' + "/" + '500' + ".chkpnt"
    tester = Tester(dataset, best_model_path)
    tester.test()

    print("~~~~ Testing on the 600 epoch ~~~~")
    best_model_path = "models/" + args.dataset + "/" + 'complex' + "/" + '600' + ".chkpnt"
    tester = Tester(dataset, best_model_path)
    tester.test()

    print("~~~~ Testing on the 700 epoch ~~~~")
    best_model_path = "models/" + args.dataset + "/" + 'complex' + "/" + '700' + ".chkpnt"
    tester = Tester(dataset, best_model_path)
    tester.test()

    print("~~~~ Testing on the 800 epoch ~~~~")
    best_model_path = "models/" + args.dataset + "/" + 'complex' + "/" + '800' + ".chkpnt"
    tester = Tester(dataset, best_model_path)
    tester.test()

    print("~~~~ Testing on the 900 epoch ~~~~")
    best_model_path = "models/" + args.dataset + "/" + 'complex' + "/" + '900' + ".chkpnt"
    tester = Tester(dataset, best_model_path)
    tester.test()

    print("~~~~ Testing on the 1000 epoch ~~~~")
    best_model_path = "models/" + args.dataset + "/" + 'complex' + "/" + '1000' + ".chkpnt"
    tester = Tester(dataset, best_model_path)
    tester.test()