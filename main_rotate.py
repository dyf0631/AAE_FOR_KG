from trainer_rotate import Trainer
...
if __name__ == '__main__':
    ...
    model_path = "models/" + args.dataset + "/"  + 'rotate' + "/" + '100' + ".chkpnt"
    tester = Tester(dataset, model_path, "test")
    tester.test()

    print("~~~~ Testing on the 200 epoch ~~~~")
    model_path = "models/" + args.dataset + "/"  + 'rotate' + "/" + '200' + ".chkpnt"
    tester = Tester(dataset, model_path, "test")
    tester.test()

    print("~~~~ Testing on the 300 epoch ~~~~")
    model_path = "models/" + args.dataset + "/"  + 'rotate' + "/" + '300' + ".chkpnt"
    tester = Tester(dataset, model_path, "test")
    tester.test()

    print("~~~~ Testing on the 400 epoch ~~~~")
    model_path = "models/" + args.dataset + "/"  + 'rotate' + "/" + '400' + ".chkpnt"
    tester = Tester(dataset, model_path, "test")
    tester.test()

    print("~~~~ Testing on the 500 epoch ~~~~")
    model_path = "models/" + args.dataset + "/"  + 'rotate' + "/" + '500' + ".chkpnt"
    tester = Tester(dataset, model_path, "test")
    tester.test()

    print("~~~~ Testing on the 600 epoch ~~~~")
    model_path = "models/" + args.dataset + "/"  + 'rotate' + "/" + '600' + ".chkpnt"
    tester = Tester(dataset, model_path, "test")
    tester.test()

    print("~~~~ Testing on the 700 epoch ~~~~")
    model_path = "models/" + args.dataset + "/"  + 'rotate' + "/" + '700' + ".chkpnt"
    tester = Tester(dataset, model_path, "test")
    tester.test()

    print("~~~~ Testing on the 800 epoch ~~~~")
    model_path = "models/" + args.dataset + "/"  + 'rotate' + "/" + '800' + ".chkpnt"
    tester = Tester(dataset, model_path, "test")
    tester.test()

    print("~~~~ Testing on the 900 epoch ~~~~")
    model_path = "models/" + args.dataset + "/"  + 'rotate' + "/" + '900' + ".chkpnt"
    tester = Tester(dataset, model_path, "test")
    tester.test()

    print("~~~~ Testing on the 1000 epoch ~~~~")
    model_path = "models/" + args.dataset + "/"  + 'rotate' + "/" + '1000' + ".chkpnt"
    tester = Tester(dataset, model_path, "test")
    tester.test()